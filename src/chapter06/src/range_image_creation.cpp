...
int main(int argc, char **argv)
{
    ...
    pcl::io::loadPCDFile("./src/chapter06/pcd/bunny.pcd", pointCloud);
    ...
    */
    ...
    // 添加深度图点云 - 修复后的代码
    pcl::visualization::PointCloudColorHandlerCustom<pcl::PointWithRange> range_image_color_handler(rangeImage.makeShared(), 0, 0, 0);
