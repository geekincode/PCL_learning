...
{
    char* input = "./src/chapter01/pcd/mid_360.STL";
    char* output = "./src/chapter01/output/mid_360.ply";
	...
	int length;
	int position = 80;
	fstream fileIn(input, ios::in | ios::binary);
	...
	ofstream fileOut(output, ios::binary | ios::out | ios::trunc);
