...
main (int argc, char** argv)
{
  ...
  reader.read ("src/chapter11/src/2在平面模型上提取凸（凹）多边形/table_scene_mug_stereo_textured.pcd", *cloud);
  // 建立过滤器消除杂散的NaN
...
// 分割
  ...
  writer.write ("src/chapter11/src/2在平面模型上提取凸（凹）多边形/table_scene_mug_stereo_textured_hull.pcd", *cloud_hull, false);
