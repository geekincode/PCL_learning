...
int main(int argc, char **argv)
{
    ...
    reader.read("src/chapter12/src/2cylinder_segmentation/table_scene_mug_stereo_textured.pcd", *cloud);
    ...
    writer.write("src/chapter12/src/2cylinder_segmentation/table_scene_mug_stereo_textured_plane.pcd", *cloud_plane, false); // 分割得到的平面
