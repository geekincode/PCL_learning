...
main (int argc, char** argv)
{
  ...
  reader.read ("./src/chapter09/src/2VoxelGrid滤波器对点云进行下采样/table_scene_lms400.pcd", *cloud);    //读取点云到cloud中
...
**********************************************************************************/
  ...
  writer.write ("./src/chapter09/src/2VoxelGrid滤波器对点云进行下采样/table_scene_lms400_downsampled.pcd", *cloud_filtered, 
